...
const Works = ({ category = "all", showCategories = false }) => {
  ...
  return (
    ...
    <section id="work" className="flex flex-col min-h-screen pt-10 pb-32">
      ...
      {showCategories ? (
        // === MODE KARTU (Home) ===
        <div className="flex flex-col md:flex-row gap-6 px-4 md:px-10 mt-10 justify-center items-stretch min-h-[400px] overflow-hidden">
          {/* Card Guru */}
          <Link
            to="/guru"
          ...
          >
            ...
            <p className="text-sm opacity-70 group-hover:opacity-100 transition-opacity">
              See educational projects, teaching modules, and teaching
              experience.
            </p>
          ...
          >
            <div className="mb-auto">
              <Icon icon="ph:code-bold" className="size-12 mb-4" />
            </div>
            <h3 className="text-3xl font-bold mb-2">
              Web
              <br />
            ...
            <p className="text-sm opacity-70 group-hover:opacity-100 transition-opacity">
              See website projects, applications, and coding explorations.
            </p>
            <div className="absolute top-6 right-6">
              <Icon
                icon="lucide:arrow-right"
          ...
          >
            <div className="mb-auto">
              <Icon icon="ph:paint-brush-broad" className="size-12 mb-4" />
            </div>
            <h3 className="text-3xl font-bold mb-2">
              Graphic
              <br />
        ...
        <div
          className="relative flex flex-col font-light mt-10 overflow-hidden"
        ...
        >
          {filteredProjects.map((project, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-start md:items-center px-4 md:px-10 text-black transition-all duration-500 md:group-hover:px-12 md:group-hover:text-white">
                <h2 className="lg:text-[40px] text-[28px] font-medium leading-none">
                  {project.name}
                </h2>
              ...
              <div className="flex px-4 md:px-10 mt-2 text-xs leading-loose uppercase transition-all duration-500 md:text-sm gap-x-5 md:group-hover:px-12">
                {project.frameworks &&
                  project.frameworks.map((fw, i) => (
                    <p
                      key={i}
                      className="text-black/60 transition-colors duration-500 md:group-hover:text-white/80"
                    >
                      #{fw.name}
                    </p>
                  ))}
          ...
          <div
            ref={previewRef}
            className="fixed -top-2/6 left-0 z-50 overflow-hidden border-4 border-black pointer-events-none w-[400px] h-[250px] md:block hidden opacity-0 bg-white"
          >
